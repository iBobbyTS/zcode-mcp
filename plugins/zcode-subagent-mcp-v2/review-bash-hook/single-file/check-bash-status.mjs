...
const POLICY_VERSION = 'zcode-readonly-bash/v1.0.0';
const MAX_COMMAND_BYTES = 16 * 1024;
const MAX_ARGUMENTS = 128;
const MAX_PATH_ARGUMENTS = 64;
const DEFAULT_TRUSTED_BIN_DIRS = Object.freeze([
...
function renderCanonicalCommand(argv, environmentAssignments = []) {
...
function tokenizeSimpleCommand(source) {
...
function createPathContext(cwdInput, rootInput) {
...
function validatePathArgument(raw, context, options = {}) {
...
function evaluateCommand({ command, cwd, root, unknownDecision = 'deny', trustedBinDirs }) {
...
function evaluateHookInput(input, env = process.env) {
...
function createHookOutput(evaluated) {
